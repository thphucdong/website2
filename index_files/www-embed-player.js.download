...
var Xc;if(z.document&&Lc){var Yc=Qc();Xc=Yc?Yc:parseInt(Vc,10)||void 0}else Xc=void 0;var Zc=Xc;var $c=Fc()||C("iPod"),ad=C("iPad");Yb();Xb();var bd=Wb()&&!(Fc()||C("iPad")||C("iPod"));var cd={},dd=null;
...
var hd={};var id;function jd(a,b){if(b!==hd)throw Error("illegal external caller");this.ka=a;if(null!=a&&0===a.length)throw Error("ByteString should be constructed with non-empty values");}
function kd(){return id||(id=new jd(null,hd))}
jd.prototype.isEmpty=function(){return null==this.ka};var ld="function"===typeof Symbol&&"symbol"===typeof Symbol()?Symbol(void 0):void 0;function md(a,b){Object.isFrozen(a)||(ld?a[ld]|=b:void 0!==a.fa?a.fa|=b:Object.defineProperties(a,{fa:{value:b,configurable:!0,writable:!0,enumerable:!1}}))}
function nd(a,b){Object.isExtensible(a)&&(ld?a[ld]&&(a[ld]&=~b):void 0!==a.fa&&(a.fa&=~b))}
function od(a){var b;ld?b=a[ld]:b=a.fa;return null==b?0:b}
function td(a,b){ld?a[ld]=b:void 0!==a.fa?a.fa=b:Object.defineProperties(a,{fa:{value:b,configurable:!0,writable:!0,enumerable:!1}})}
function ud(a){md(a,1);return a}
function vd(a){md(a,17);return a}
function wd(a){return a?!!(od(a)&2):!1}
function xd(a){md(a,16);return a}
function yd(a){if(!Array.isArray(a))throw Error("cannot mark non-array as shared mutably");nd(a,16)}
function zd(a,b){td(b,(od(a)|0)&-51)}
;var Ad={};function Bd(a){return null!==a&&"object"===typeof a&&!Array.isArray(a)&&a.constructor===Object}
var Cd,Dd=Object.freeze(ud([]));function Ed(a){if(wd(a.v))throw Error("Cannot mutate an immutable Message");}
...
;function Hd(a){switch(typeof a){case "number":return isFinite(a)?a:String(a);case "object":if(a&&!Array.isArray(a)){if(gd(a))return ed(a);if(a instanceof jd){var b=a.ka;return null==b?"":"string"===typeof b?b:a.ka=ed(b)}}}return a}
;function Id(a,b,c,d){if(null!=a){if(Array.isArray(a))a=Jd(a,b,c,void 0!==d);else if(Bd(a)){var e={},f;for(f in a)e[f]=Id(a[f],b,c,d);a=e}else a=b(a,d);return a}}
function Jd(a,b,c,d){d=d?!!(od(a)&16):void 0;var e=Array.prototype.slice.call(a);c(a,e);for(a=0;a<e.length;a++)e[a]=Id(e[a],b,c,d);return e}
function Kd(a){return a.Eb===Ad?a.toJSON():Hd(a)}
function Ld(a){if(!a)return a;if("object"===typeof a){if(gd(a))return new Uint8Array(a);if(a.Eb===Ad)return a.clone()}return a}
function Md(){}
;function Nd(a,b,c){return-1===b?null:b>=a.qa?a.S?a.S[b]:void 0:(void 0===c?0:c)&&a.S&&(c=a.S[b],null!=c)?c:a.v[b+a.ma]}
function D(a,b,c,d,e){d=void 0===d?!1:d;(void 0===e?0:e)||Ed(a);a.jc&&(a.jc=void 0);if(b>=a.qa||d)return(a.S||(a.S=a.v[a.qa+a.ma]={}))[b]=c,a;void 0!==a.S&&a.qa>=a.v.length?(d=a.v.length-1,e=b+a.ma,e>=d?(a.v[d]=void 0,a.v[e]=c,a.v.push(a.S)):a.v[e]=c):a.v[b+a.ma]=c;void 0!==a.S&&b in a.S&&delete a.S[b];return a}
function Od(a,b,c,d){var e=Nd(a,b,d);Array.isArray(e)||(e=Dd);var f=od(e);f&1||ud(e);wd(a.v)?c&1||(md(e,2),Object.freeze(e)):e===Dd||!(c&1&&c&2)&&f&2?(e=ud(Array.prototype.slice.call(e)),D(a,b,e,d)):!(c&2)&&f&16&&yd(e);return e}
function Pd(a,b,c,d){Ed(a);(c=Qd(a,c))&&c!==b&&null!=d&&D(a,c,void 0,!1);return D(a,b,d)}
function Qd(a,b){for(var c=0,d=0;d<b.length;d++){var e=b[d];null!=Nd(a,e)&&(0!==c&&D(a,c,void 0,!1,!0),c=e)}return c}
function Rd(a,b,c,d){var e=d=void 0===d?!1:d,f=Nd(a,c,e);var g=!1;var h=null==f||"object"!==typeof f||(g=Array.isArray(f))||f.Eb!==Ad?g?new b(f):void 0:f;h!==f&&null!=h&&(D(a,c,h,e,!0),md(h.v,od(a.v)&-33));b=h;if(null==b)return b;wd(b.v)&&!wd(a.v)&&(b=Sd(b),D(a,c,b,d));return b}
function Td(a,b,c,d,e){e=void 0===e?!0:e;a.i||(a.i={});var f=a.i[c],g=Od(a,c,3,d),h=wd(a.v),k=!!(od(a.v)&16),m=wd(g),q=h||m;!e&&m&&(g=ud(Array.prototype.slice.call(g)),D(a,c,g,d));if(!f){f=[];d=q;for(m=0;m<g.length;m++){var r=g[m];d=d||wd(r);var w=b,t=k,y=!1;y=void 0===y?!1:y;t=void 0===t?!1:t;r=Array.isArray(r)?new w(t?xd(r):r):y?new w:void 0;void 0!==r&&(f.push(r),q&&md(r.v,2))}a.i[c]=f;b=g;g=!d;Object.isFrozen(b)||(k=od(b)|33,td(b,g?k|8:k&-9))}e=h||e;h=wd(f);e&&!h&&(Object.isFrozen(f)&&(a.i[c]=
f=f.slice()),md(f,2),Object.freeze(f));!e&&h&&(a.i[c]=f=f.slice());return f}
function Ud(a,b,c,d){d=void 0===d?!1:d;var e=wd(a.v);b=Td(a,b,c,d,e);a=Od(a,c,3,d);if(e=!e&&a){if(!a)throw Error("cannot check mutability state of non-array");e=!(od(a)&8)}if(e){for(e=0;e<b.length;e++)(c=b[e])&&wd(c.v)&&(c=e,d=Sd(b[e]),b[c]=d,a[e]=b[e].v);md(a,8)}return b}
function G(a,b,c,d){Ed(a);null!=d?Gd(d,b):d=void 0;return D(a,c,d)}
function Vd(a,b,c,d,e){Ed(a);null!=e?Gd(e,b):e=void 0;Pd(a,c,d,e)}
function Wd(a,b,c,d){Ed(a);if(null!=d){var e=ud([]);for(var f=!1,g=0;g<d.length;g++)e[g]=Gd(d[g],b).v,f=f||wd(e[g]);a.i||(a.i={});a.i[c]=d;b=e;f?nd(b,8):md(b,8)}else a.i&&(a.i[c]=void 0),e=Dd;return D(a,c,e)}
function Xd(a,b,c,d){Ed(a);var e=Td(a,c,b,void 0,!1);c=null!=d?Gd(d,c):new c;a=Od(a,b,2);e.push(c);a.push(c.v);wd(c.v)&&nd(a,8)}
function Yd(a,b){return Nd(a,b)}
function Zd(a,b){return null==a?b:a}
;function $d(a,b,c,d,e,f){(a=a.i&&a.i[c])?(e=f.sb?ud(a.slice()):a,Wd(b,0<e.length?e[0].constructor:void 0,c,e)):(fd&&d instanceof Uint8Array?e=d.length?new jd(new Uint8Array(d),hd):kd():(Array.isArray(d)&&(e?md(d,2):d&&od(d)&1&&f.sb?(e=Array.prototype.slice.call(d),td(e,(od(d)|0)&-51),d=e):yd(d)),e=d),D(b,c,e))}
;function Sd(a){if(!wd(a.v))return a;var b={sb:!0},c=wd(a.v);if(c&&!b.sb)throw Error("copyRepeatedFields must be true for frozen messages");c||yd(a.v);var d=new a.constructor;a.Ma&&(d.Ma=a.Ma.slice());for(var e=a.v,f=0;f<e.length;f++){var g=e[f];if(f===e.length-1&&Bd(g))for(var h in g){var k=+h;Number.isNaN(k)?(d.S||(d.S=d.v[d.qa+d.ma]={}))[h]=g[h]:$d(a,d,k,g[h],c,b)}else $d(a,d,f-a.ma,g,c,b)}d.jc=a;return d}
;function I(a,b,c){null==a&&(a=ae);ae=null;var d=this.constructor.i||0,e=0<d,f=this.constructor.j,g,h=!1;if(a){if(g=!!(od(a)&16))h=od(a),td(a,h|32),h=!!(h&32)}else g=f?[f]:[],md(g,48),a=g,g=!0;e&&0<a.length&&Bd(a[a.length-1])&&"g"in a[a.length-1]&&(d=0);this.ma=(f?0:-1)-d;this.i=void 0;this.v=a;a:{f=this.v.length;d=f-1;if(f&&(f=this.v[d],Bd(f))){this.S=f;b=Object.keys(f);0<b.length&&jb(b,isNaN)?this.qa=Number.MAX_VALUE:this.qa=d-this.ma;break a}void 0!==b&&-1<b?(this.qa=Math.max(b,d+1-this.ma),this.S=
void 0):this.qa=Number.MAX_VALUE}if(!e&&this.S&&"g"in this.S)throw Error('Unexpected "g" flag in sparse object of message that is not a group type.');if(c)for(e=g&&!h?vd:ud,b=0;b<c.length;b++)g=c[b],(h=Nd(this,g))?Array.isArray(h)&&e(h):D(this,g,Dd,!1,!0)}
l=I.prototype;l.toJSON=function(){var a=this.v,b;Cd?b=a:b=Jd(a,Kd,Md);return b};
function be(a){Cd=!0;try{return JSON.stringify(a.toJSON(),ce)}finally{Cd=!1}}
l.clone=function(){var a=Jd(this.v,Ld,zd);xd(a);ae=a;a=new this.constructor(a);ae=null;de(a,this);return a};
l.isMutable=function(){return!wd(this.v)};
l.Eb=Ad;l.toString=function(){return this.v.toString()};
function ce(a,b){return Hd(b)}
function de(a,b){b.Ma&&(a.Ma=b.Ma.slice());var c=b.i;if(c){b=b.S;for(var d in c){var e=c[d];if(e){var f=!(!b||!b[d]),g=+d;if(Array.isArray(e)){if(e.length)for(f=Ud(a,e[0].constructor,g,f),g=0;g<Math.min(f.length,e.length);g++)de(f[g],e[g])}else throw Error("unexpected object: type: "+Oa(e)+": "+e);}}}}
var ae;function ee(a){var b=this.i,c=this.j;return this.isRepeated?Ud(a,b,c,!0):Rd(a,b,c,!0)}
;function fe(a){this.Vb=a}
;function ge(a,b,c){this.j=a;this.m=b;this.i=c||[];this.Ca=new Map}
l=ge.prototype;l.Hc=function(a){var b=Ja.apply(1,arguments),c=this.vb(b);c?c.push(new fe(a)):this.wc(a,b)};
l.wc=function(a){this.Ca.set(this.dc(Ja.apply(1,arguments)),[new fe(a)])};
...
l.dc=function(){var a=Ja.apply(0,arguments);return a?a.join(","):"key"};function he(a,b){ge.call(this,a,3,b)}
u(he,ge);he.prototype.l=function(a){var b=Ja.apply(1,arguments),c=0,d=this.Tc(b);d&&(c=d.Vb);this.wc(c+a,b)};function ie(a,b){ge.call(this,a,2,b)}
u(ie,ge);ie.prototype.l=function(a){this.Hc(a,Ja.apply(1,arguments))};function je(a){a&&"function"==typeof a.dispose&&a.dispose()}
;function ke(a){for(var b=0,c=arguments.length;b<c;++b){var d=arguments[b];Pa(d)?ke.apply(null,d):je(d)}}
...
function me(a,b){a.O?b():(a.C||(a.C=[]),a.C.push(b))}
J.prototype.D=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function ne(a,b){this.type=a;this.i=this.target=b;this.defaultPrevented=this.l=!1}
ne.prototype.stopPropagation=function(){this.l=!0};
ne.prototype.preventDefault=function(){this.defaultPrevented=!0};function oe(a){var b=B("window.location.href");null==a&&(a='Unknown Error of type "null/undefined"');if("string"===typeof a)return{message:a,name:"Unknown error",lineNumber:"Not available",fileName:b,stack:"Not available"};var c=!1;try{var d=a.lineNumber||a.line||"Not available"}catch(g){d="Not available",c=!0}try{var e=a.fileName||a.filename||a.sourceURL||z.$googDebugFname||b}catch(g){e="Not available",c=!0}b=pe(a);if(!(!c&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name)){c=a.message;if(null==
...
var qe={};var se=function(){if(!z.addEventListener||!Object.defineProperty)return!1;var a=!1,b=Object.defineProperty({},"passive",{get:function(){a=!0}});
try{z.addEventListener("test",function(){},b),z.removeEventListener("test",function(){},b)}catch(c){}return a}();function te(a,b){ne.call(this,a?a.type:"");this.relatedTarget=this.i=this.target=null;this.button=this.screenY=this.screenX=this.clientY=this.clientX=0;this.key="";this.charCode=this.keyCode=0;this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1;this.state=null;this.pointerId=0;this.pointerType="";this.j=null;a&&this.init(a,b)}
Za(te,ne);var ze={2:"touch",3:"pen",4:"mouse"};
te.prototype.init=function(a,b){var c=this.type=a.type,d=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;this.target=a.target||a.srcElement;this.i=b;if(b=a.relatedTarget){if(Nc){a:{try{Hc(b.nodeName);var e=!0;break a}catch(f){}e=!1}e||(b=null)}}else"mouseover"==c?b=a.fromElement:"mouseout"==c&&(b=a.toElement);this.relatedTarget=b;d?(this.clientX=void 0!==d.clientX?d.clientX:d.pageX,this.clientY=void 0!==d.clientY?d.clientY:d.pageY,this.screenX=d.screenX||0,this.screenY=d.screenY||
...
this.j=a;a.defaultPrevented&&te.Z.preventDefault.call(this)};
te.prototype.stopPropagation=function(){te.Z.stopPropagation.call(this);this.j.stopPropagation?this.j.stopPropagation():this.j.cancelBubble=!0};
te.prototype.preventDefault=function(){te.Z.preventDefault.call(this);var a=this.j;a.preventDefault?a.preventDefault():a.returnValue=!1};var Ae="closure_listenable_"+(1E6*Math.random()|0);var Be=0;function Ce(a,b,c,d,e){this.listener=a;this.proxy=null;this.src=b;this.type=c;this.capture=!!d;this.gb=e;this.key=++Be;this.Oa=this.ab=!1}
function De(a){a.Oa=!0;a.listener=null;a.proxy=null;a.src=null;a.gb=null}
;function Ee(a){this.src=a;this.listeners={};this.i=0}
Ee.prototype.add=function(a,b,c,d,e){var f=a.toString();a=this.listeners[f];a||(a=this.listeners[f]=[],this.i++);var g=Fe(a,b,d,e);-1<g?(b=a[g],c||(b.ab=!1)):(b=new Ce(b,this.src,f,!!d,e),b.ab=c,a.push(b));return b};
Ee.prototype.remove=function(a,b,c,d){a=a.toString();if(!(a in this.listeners))return!1;var e=this.listeners[a];b=Fe(e,b,c,d);return-1<b?(De(e[b]),Array.prototype.splice.call(e,b,1),0==e.length&&(delete this.listeners[a],this.i--),!0):!1};
function Ge(a,b){var c=b.type;c in a.listeners&&lb(a.listeners[c],b)&&(De(b),0==a.listeners[c].length&&(delete a.listeners[c],a.i--))}
function Fe(a,b,c,d){for(var e=0;e<a.length;++e){var f=a[e];if(!f.Oa&&f.listener==b&&f.capture==!!c&&f.gb==d)return e}return-1}
;var He="closure_lm_"+(1E6*Math.random()|0),Ie={},Je=0;function Ke(a,b,c,d,e){if(d&&d.once)Le(a,b,c,d,e);else if(Array.isArray(b))for(var f=0;f<b.length;f++)Ke(a,b[f],c,d,e);else c=Me(c),a&&a[Ae]?a.ia(b,c,Qa(d)?!!d.capture:!!d,e):Ne(a,b,c,!1,d,e)}
function Ne(a,b,c,d,e,f){if(!b)throw Error("Invalid event type");var g=Qa(e)?!!e.capture:!!e,h=Oe(a);h||(a[He]=h=new Ee(a));c=h.add(b,c,d,g,f);if(!c.proxy){d=Pe();c.proxy=d;d.src=a;d.listener=c;if(a.addEventListener)se||(e=g),void 0===e&&(e=!1),a.addEventListener(b.toString(),d,e);else if(a.attachEvent)a.attachEvent(Qe(b.toString()),d);else if(a.addListener&&a.removeListener)a.addListener(d);else throw Error("addEventListener and attachEvent are unavailable.");Je++}}
function Pe(){function a(c){return b.call(a.src,a.listener,c)}
var b=Re;return a}
function Le(a,b,c,d,e){if(Array.isArray(b))for(var f=0;f<b.length;f++)Le(a,b[f],c,d,e);else c=Me(c),a&&a[Ae]?a.m.add(String(b),c,!0,Qa(d)?!!d.capture:!!d,e):Ne(a,b,c,!0,d,e)}
function Se(a,b,c,d,e){if(Array.isArray(b))for(var f=0;f<b.length;f++)Se(a,b[f],c,d,e);else(d=Qa(d)?!!d.capture:!!d,c=Me(c),a&&a[Ae])?a.m.remove(String(b),c,d,e):a&&(a=Oe(a))&&(b=a.listeners[b.toString()],a=-1,b&&(a=Fe(b,c,d,e)),(c=-1<a?b[a]:null)&&Te(c))}
function Te(a){if("number"!==typeof a&&a&&!a.Oa){var b=a.src;if(b&&b[Ae])Ge(b.m,a);else{var c=a.type,d=a.proxy;b.removeEventListener?b.removeEventListener(c,d,a.capture):b.detachEvent?b.detachEvent(Qe(c),d):b.addListener&&b.removeListener&&b.removeListener(d);Je--;(c=Oe(b))?(Ge(c,a),0==c.i&&(c.src=null,b[He]=null)):De(a)}}}
function Qe(a){return a in Ie?Ie[a]:Ie[a]="on"+a}
function Re(a,b){if(a.Oa)a=!0;else{b=new te(b,this);var c=a.listener,d=a.gb||a.src;a.ab&&Te(a);a=c.call(d,b)}return a}
...
return a[Ue]}
;function Ve(){J.call(this);this.m=new Ee(this);this.Ec=this;this.la=null}
...
function We(a,b){var c=a.la;if(c){var d=[];for(var e=1;c;c=c.la)d.push(c),++e}a=a.Ec;c=b.type||b;"string"===typeof b?b=new ne(b,a):b instanceof ne?b.target=b.target||a:(e=b,b=new ne(c,a),yb(b,e));e=!0;if(d)for(var f=d.length-1;!b.l&&0<=f;f--){var g=b.i=d[f];e=Xe(g,c,!0,b)&&e}b.l||(g=b.i=a,e=Xe(g,c,!0,b)&&e,b.l||(e=Xe(g,c,!1,b)&&e));if(d)for(f=0;!b.l&&f<d.length;f++)g=b.i=d[f],e=Xe(g,c,!1,b)&&e}
Ve.prototype.D=function(){Ve.Z.D.call(this);if(this.m){var a=this.m,b=0,c;for(c in a.listeners){for(var d=a.listeners[c],e=0;e<d.length;e++)++b,De(d[e]);delete a.listeners[c];a.i--}}this.la=null};
Ve.prototype.ia=function(a,b,c,d){return this.m.add(String(a),b,!1,c,d)};
function Xe(a,b,c,d){b=a.m.listeners[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,f=0;f<b.length;++f){var g=b[f];if(g&&!g.Oa&&g.capture==c){var h=g.listener,k=g.gb||g.src;g.ab&&Ge(a.m,g);e=!1!==h.call(k,d)&&e}}return e&&!d.defaultPrevented}
...
;function $e(a,b){return a+Math.random()*(b-a)}
;function af(a,b){this.x=void 0!==a?a:0;this.y=void 0!==b?b:0}
l=af.prototype;l.clone=function(){return new af(this.x,this.y)};
l.equals=function(a){return a instanceof af&&(this==a?!0:this&&a?this.x==a.x&&this.y==a.y:!1)};
...
l.scale=function(a,b){this.x*=a;this.y*="number"===typeof b?b:a;return this};function bf(a,b){this.width=a;this.height=b}
l=bf.prototype;l.clone=function(){return new bf(this.width,this.height)};
...
l.scale=function(a,b){this.width*=a;this.height*="number"===typeof b?b:a;return this};function cf(a){var b=document;return"string"===typeof a?b.getElementById(a):a}
function df(a){var b=document;a=String(a);"application/xhtml+xml"===b.contentType&&(a=a.toLowerCase());return b.createElement(a)}
function ef(a,b){for(var c=0;a;){if(b(a))return a;a=a.parentNode;c++}return null}
;var ff;function gf(){var a=z.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&!C("Presto")&&(a=function(){var e=df("IFRAME");e.style.display="none";document.documentElement.appendChild(e);var f=e.contentWindow;e=f.document;e.open();e.close();var g="callImmediate"+Math.random(),h="file:"==f.location.protocol?"*":f.location.protocol+"//"+f.location.host;e=Xa(function(k){if(("*"==h||k.origin==h)&&k.data==g)this.port1.onmessage()},this);
...
return function(e){d.next={Ub:e};d=d.next;b.port2.postMessage(0)}}return function(e){z.setTimeout(e,0)}}
...
var jf=new Ye(function(){return new kf},function(a){return a.reset()});
...
"function"!==typeof z.setImmediate||z.Window&&z.Window.prototype&&!C("Edge")&&z.Window.prototype.setImmediate==z.setImmediate?(ff||(ff=gf()),ff(b)):z.setImmediate(b)}}
function qf(){for(var a;a=nf.remove();){try{a.i.call(a.scope)}catch(b){Ec(b)}Ze(jf,a)}mf=!1}
...
var uf=new Ye(function(){return new tf},function(a){a.reset()});
...
function Bf(a,b,c,d){if(3==c&&b.onRejected&&!b.l)for(;a&&a.o;a=a.l)a.o=!1;if(b.i)b.i.l=null,Gf(b,c,d);else try{b.l?b.j.call(b.context):Gf(b,c,d)}catch(e){Hf.call(null,e)}Ze(uf,b)}
...
var Hf=Ec;function yf(a){ab.call(this,a)}
Za(yf,ab);yf.prototype.name="cancel";function If(a,b){Ve.call(this);this.l=a||1;this.j=b||z;this.o=Xa(this.zd,this);this.s=Date.now()}
Za(If,Ve);l=If.prototype;l.enabled=!1;l.ca=null;function Jf(a,b){a.l=b;a.ca&&a.enabled?(a.stop(),a.start()):a.ca&&a.stop()}
l.zd=function(){if(this.enabled){var a=Date.now()-this.s;0<a&&a<.8*this.l?this.ca=this.j.setTimeout(this.o,this.l-a):(this.ca&&(this.j.clearTimeout(this.ca),this.ca=null),We(this,"tick"),this.enabled&&(this.stop(),this.start()))}};
...
function Kf(a,b,c){if("function"===typeof a)c&&(a=Xa(a,c));else if(a&&"function"==typeof a.handleEvent)a=Xa(a.handleEvent,a);else throw Error("Invalid listener argument");return 2147483647<Number(b)?-1:z.setTimeout(a,b||0)}
...
l.Ic=function(a){var b=Ja.apply(1,arguments);this.i.has(a)||this.i.set(a,new he(a,b))};
l.Sb=function(a){var b=Ja.apply(1,arguments);this.i.has(a)||this.i.set(a,new ie(a,b))};
function Of(a,b){return a.s.has(b)?void 0:a.i.get(b)}
l.Mb=function(a){this.Cc.apply(this,[a,1].concat(ia(Ja.apply(1,arguments))))};
l.Cc=function(a,b){var c=Ja.apply(2,arguments),d=Of(this,a);d&&d instanceof he&&(d.l(b,c),Mf(this))};
l.pb=function(a,b){var c=Ja.apply(2,arguments),d=Of(this,a);d&&d instanceof ie&&(d.l(b,c),Mf(this))};
...
;function dg(a,b,c){var d=String(z.location.href);return d&&a&&b?[b,eg(bg(d),a,c||null)].join(" "):null}
...
l=hg.prototype;l.isEnabled=function(){if(!z.navigator.cookieEnabled)return!1;if(!this.isEmpty())return!0;this.set("TESTCOOKIESENABLED","1",{hb:60});if("1"!==this.get("TESTCOOKIESENABLED"))return!1;this.remove("TESTCOOKIESENABLED");return!0};
...
function lg(a){a=void 0===a?!1:a;var b=z.__SAPISID||z.__APISID||z.__3PSAPISID||z.__OVERRIDE_SID;kg(a)&&(b=b||z.__1PSAPISID);if(b)return!0;var c=new hg(document);b=c.get("SAPISID")||c.get("APISID")||c.get("__Secure-3PAPISID")||c.get("SID");kg(a)&&(b=b||c.get("__Secure-1PAPISID"));return!!b}
function mg(a,b,c,d){(a=z[a])||(a=(new hg(document)).get(b));return a?dg(a,c,d):null}
function ng(a,b){b=void 0===b?!1:b;var c=bg(String(z.location.href)),d=[];if(lg(b)){c=0==c.indexOf("https:")||0==c.indexOf("chrome-extension:")||0==c.indexOf("moz-extension:");var e=c?z.__SAPISID:z.__APISID;e||(e=new hg(document),e=e.get(c?"SAPISID":"APISID")||e.get("__Secure-3PAPISID"));(e=e?dg(e,c?"SAPISIDHASH":"APISIDHASH",a):null)&&d.push(e);c&&kg(b)&&((b=mg("__1PSAPISID","__Secure-1PAPISID","SAPISID1PHASH",a))&&d.push(b),(a=mg("__3PSAPISID","__Secure-3PAPISID","SAPISID3PHASH",a))&&d.push(a))}return 0==
...
zg=new Ag;function Cg(a){Ve.call(this);this.headers=new Map;this.L=a||null;this.j=!1;this.K=this.A=null;this.o=this.T="";this.l=this.R=this.u=this.P=!1;this.s=0;this.H=null;this.da="";this.X=this.Y=!1}
Za(Cg,Ve);var Dg=/^https?$/i,Eg=["POST","PUT"],Fg=[];function Gg(a,b,c,d,e,f,g){var h=new Cg;Fg.push(h);b&&h.ia("complete",b);h.m.add("ready",h.Mc,!0,void 0,void 0);f&&(h.s=Math.max(0,f));g&&(h.Y=g);h.send(a,c,d,e)}
...
e=z.FormData&&a instanceof z.FormData;!(0<=eb(Eg,b))||d||e||c.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");b=p(c);for(d=b.next();!d.done;d=b.next())c=p(d.value),d=c.next().value,c=c.next().value,this.A.setRequestHeader(d,c);this.da&&(this.A.responseType=this.da);"withCredentials"in this.A&&this.A.withCredentials!==this.Y&&(this.A.withCredentials=this.Y);try{Kg(this),0<this.s&&(this.X=Lg(this.A),this.getStatus(),this.X?(this.A.timeout=this.s,this.A.ontimeout=Xa(this.yc,this)):
this.H=Kf(this.yc,this.s,this)),this.getStatus(),this.u=!0,this.A.send(a),this.u=!1}catch(g){this.getStatus(),Hg(this,g)}};
function Lg(a){return Lc&&Wc()&&"number"===typeof a.timeout&&void 0!==a.ontimeout}
l.yc=function(){"undefined"!=typeof Ma&&this.A&&(this.o="Timed out after "+this.s+"ms, aborting",this.getStatus(),We(this,"timeout"),this.abort(8))};
function Hg(a,b){a.j=!1;a.A&&(a.l=!0,a.A.abort(),a.l=!1);a.o=b;Mg(a);Ng(a)}
function Mg(a){a.P||(a.P=!0,We(a,"complete"),We(a,"error"))}
l.abort=function(){this.A&&this.j&&(this.getStatus(),this.j=!1,this.l=!0,this.A.abort(),this.l=!1,We(this,"complete"),We(this,"abort"),Ng(this))};
...
function Og(a){if(a.j&&"undefined"!=typeof Ma)if(a.K[1]&&4==Pg(a)&&2==a.getStatus())a.getStatus();else if(a.u&&4==Pg(a))Kf(a.mc,0,a);else if(We(a,"readystatechange"),a.isComplete()){a.getStatus();a.j=!1;try{if(Qg(a))We(a,"complete"),We(a,"success");else{try{var b=2<Pg(a)?a.A.statusText:""}catch(c){b=""}a.o=b+" ["+a.getStatus()+"]";Mg(a)}}finally{Ng(a)}}}
function Ng(a,b){if(a.A){Kg(a);var c=a.A,d=a.K[0]?function(){}:null;
a.A=null;a.K=null;b||We(a,"ready");try{c.onreadystatechange=d}catch(e){}}}
function Kg(a){a.A&&a.X&&(a.A.ontimeout=null);a.H&&(z.clearTimeout(a.H),a.H=null)}
l.isActive=function(){return!!this.A};
l.isComplete=function(){return 4==Pg(this)};
function Qg(a){var b=a.getStatus();a:switch(b){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var c=!0;break a;default:c=!1}if(!c){if(b=0===b)a=nc(1,String(a.T)),!a&&z.self&&z.self.location&&(a=z.self.location.protocol.slice(0,-1)),b=!Dg.test(a?a.toLowerCase():"");c=b}return c}
...
u(bh,I);var ch;ch=new function(a,b,c){this.j=a;this.fieldName=b;this.i=c;this.isRepeated=0;this.l=ee}(175237375,{mr:0},bh);function dh(a,b,c,d,e,f,g,h,k,m,q){Ve.call(this);var r=this;this.P="";this.l=[];this.Qb="";this.Rb=this.va=-1;this.Xa=!1;this.K=this.o=null;this.H=0;this.Fc=1;this.timeoutMillis=0;this.da=!1;Ve.call(this);this.Pb=b||function(){};
this.u=new eh(a,f);this.Dc=d;this.Wa=q;this.Gc=Ya($e,0,1);this.T=e||null;this.L=c||null;this.X=g||!1;this.pageId=k||null;this.logger=null;this.withCredentials=!h;this.Ja=f||!1;!this.Ja&&(65<=cc("Chromium")||45<=cc("Firefox")||12<=cc("Safari")||(Fc()||C("iPad")||C("iPod"))&&Gc());a=D(new Vg,1,1);fh(this.u,a);this.s=new qg(1E4);this.j=new If(this.s.getValue());le(this,this.j);m=gh(this,m);Ke(this.j,"tick",m,!1,this);this.R=new If(6E5);le(this,this.R);Ke(this.R,"tick",m,!1,this);this.X||this.R.start();
this.Ja||(Ke(document,"visibilitychange",function(){"hidden"===document.visibilityState&&r.Y()}),Ke(document,"pagehide",this.Y,!1,this))}
u(dh,Ve);function gh(a,b){return b?function(){b().then(function(){a.flush()})}:function(){a.flush()}}
dh.prototype.D=function(){this.Y();Ve.prototype.D.call(this)};
...
dh.prototype.log=function(a){a=a.clone();var b=this.Fc++;D(a,21,b);this.P&&D(a,26,this.P);if(!Nd(a,1)){b=a;var c=Date.now().toString();D(b,1,c)}null!=Nd(a,15,!1)||D(a,15,60*(new Date).getTimezoneOffset());this.o&&(b=this.o.clone(),G(a,og,16,b));for(;1E3<=this.l.length;)this.l.shift(),++this.H;this.l.push(a);We(this,new jh(a));this.X||this.j.enabled||this.j.start()};
dh.prototype.flush=function(a,b){var c=this;if(0===this.l.length)a&&a();else if(this.da)kh(this);else{var d=Date.now();if(this.Rb>d&&this.va<d)b&&b("throttled");else{var e=lh(this.u,this.l,this.H);d={};var f=this.Pb();f&&(d.Authorization=f);var g=hh(this);this.L&&(d["X-Goog-AuthUser"]=this.L,g=wc(g,"authuser",this.L));this.pageId&&(d["X-Goog-PageId"]=this.pageId,g=wc(g,"pageId",this.pageId));if(f&&this.Qb===f)b&&b("stale-auth-token");else{this.l=[];this.j.enabled&&this.j.stop();this.H=0;var h=be(e),
k;this.K&&this.K.isSupported(h.length)&&(k=this.K.compress(h));var m={url:g,body:h,Kc:1,Ib:d,requestType:"POST",withCredentials:this.withCredentials,timeoutMillis:this.timeoutMillis},q=function(t){c.s.reset();Jf(c.j,c.s.getValue());if(t){var y=null;try{var E=JSON.parse(t.replace(")]}'\n",""));y=new $g(E)}catch(F){}y&&(t=Number(Zd(Nd(y,1),"-1")),0<t&&(c.va=Date.now(),c.Rb=c.va+t),y=ch.l(y))&&(y=Zd(Nd(y,1),-1),-1!=y&&(c.Xa||ih(c,y)))}a&&a()},r=function(t,y){var E=Ud(e,Wg,3),F=c.s;
F.i=Math.min(3E5,2*F.i);F.j=Math.min(3E5,F.i+Math.round(.2*(Math.random()-.5)*F.i));Jf(c.j,c.s.getValue());401===t&&f&&(c.Qb=f);void 0===y&&(y=500<=t&&600>t||401===t||0===t);y&&(c.l=E.concat(c.l),c.X||c.j.enabled||c.j.start());b&&b("net-send-failed",t)},w=function(){c.Wa?c.Wa.send(m,q,r):c.Dc(m,q,r)};
...
function kh(a){mh(a,function(b,c){b=wc(b,"format","json");b=window.navigator.sendBeacon(b,be(c));a.da&&!b&&(a.da=!1);return b})}
...
function jh(){ne.call(this,"event-logged",void 0)}
u(jh,ne);function eh(a,b){this.j=b=void 0===b?!1:b;this.uach=this.locale=null;this.i=new Yg;D(this.i,2,a);b||(this.locale=document.documentElement.getAttribute("lang"));fh(this,new Vg)}
function fh(a,b){G(a.i,Vg,1,b);Nd(b,1)||D(b,1,1);a.j||(b=nh(a),Nd(b,5)||D(b,5,a.locale));a.uach&&(b=nh(a),Rd(b,Sg,9)||G(b,Sg,9,a.uach))}
...
function nh(a){a=Rd(a.i,Vg,1);var b=Rd(a,Rg,11);b||(b=new Rg,G(a,Rg,11,b));return b}
function lh(a,b,c){c=void 0===c?0:c;a=a.i.clone();var d=Date.now().toString();a=D(a,4,d);b=Wd(a,Wg,3,b);c&&D(b,14,c);return b}
...
;function rh(){var a=void 0===a?"":a;var b=void 0===b?"":b;var c=new qh;c.i="";""!=a&&(c.l=a);b&&(c.j=b);a=new dh(1828,c.K?c.K:ng,"0",c.o,c.l,c.u,!1,c.R,void 0,void 0,c.s?c.s:void 0);c.O&&fh(a.u,c.O);if(c.j){b=c.j;var d=nh(a.u);D(d,7,b)}c.m&&(a.K=c.m);c.i&&(a.P=c.i);c.C&&((b=c.C)?(a.o||(a.o=new og),b=be(b),D(a.o,4,b)):a.o&&D(a.o,4,void 0,!1));c.L&&(d=c.L,a.o||(a.o=new og),b=a.o,null==d?d=Dd:ud(d),D(b,2,d));c.H&&(b=c.H,a.Xa=!0,ih(a,b));c.P&&oh(a.u,c.P);this.i=a}
rh.prototype.flush=function(a){var b=a||[];if(b.length){a=new $f;for(var c=[],d=0;d<b.length;d++){var e=b[d],f=e,g=new Sf;var h=D(g,1,f.j);var k=f;g=[];for(var m=0;m<k.i.length;m++)g.push(k.i[m].tb);if(null==g)g=Dd;else{for(k=0;k<g.length;k++);md(g,5)}g=D(h,3,g);h=[];k=[];m=p(f.Ca.keys());for(var q=m.next();!q.done;q=m.next())k.push(q.value.split(","));for(m=0;m<k.length;m++){q=k[m];var r=f.m;for(var w=f.vb(q)||[],t=[],y=0;y<w.length;y++){var E=w[y];E=E&&E.Vb;var F=new Xf;switch(r){case 3:Pd(F,1,
Zf,Number(E));break;case 2:Pd(F,2,Zf,Number(E))}t.push(F)}r=t;for(w=0;w<r.length;w++){t=r[w];y=new Uf;t=G(y,Xf,2,t);y=q;E=[];F=f;for(var O=[],N=0;N<F.i.length;N++)O.push(F.i[N].ub);F=O;for(O=0;O<F.length;O++){N=F[O];var Q=y[O],da=new Wf;switch(N){case 3:Pd(da,1,Yf,String(Q));break;case 2:Pd(da,2,Yf,Number(Q));break;case 1:Pd(da,3,Yf,"true"==Q)}E.push(da)}Wd(t,Wf,1,E);h.push(t)}}Wd(g,Uf,4,h);c.push(g);e.clear()}Wd(a,Sf,1,c);b=this.i;a instanceof Wg?b.log(a):(c=new Wg,a=be(a),a=D(c,8,a),b.log(a));this.i.flush()}};function sh(){this.s=th();this.m=new rh;this.i=new Lf(this.m);this.o=new Pf(this.i);this.j=new Qf(this.i);this.l=new Rf(this.i);this.Fa=window.document.location.hostname}
...
;var Kh=(new Date).getTime();var Lh="client_dev_domain client_dev_regex_map client_dev_root_url client_rollout_override expflag forcedCapability jsfeat jsmode mods".split(" ");ia(Lh);function Mh(a){Ve.call(this);var b=this;this.u=this.l=0;this.aa=null!=a?a:{V:function(e,f){return setTimeout(e,f)},
...
u(Mh,Ve);function Ph(){var a=Qh;Mh.i||(Mh.i=new Mh(a));return Mh.i}
...
signal:f}),5);case 5:g=!0;case 3:Ba(h);a.s=void 0;a.l&&(a.aa.ga(a.l),a.l=0);g!==a.j&&(a.j=g,a.j?We(a,"networkstatus-online"):We(a,"networkstatus-offline"));c(g);Ca(h);break;case 2:Aa(h),g=!1,h.B(3)}})})}
...
return a.i}
;function Th(a,b){this.i=a[z.Symbol.iterator]();this.j=b}
...
u(Ei,I);Ei.prototype.getKey=function(){return Nd(this,1)};
Ei.prototype.getValue=function(){return Yd(this,2===Qd(this,Fi)?2:-1)};
Ei.prototype.setValue=function(a){return Pd(this,2,Fi,a)};
...
u(Ki,I);Ki.prototype.getPlayerType=function(){return Nd(this,36)};
...
u(bj,I);bj.prototype.getKey=function(){return Zd(Nd(this,1),"")};
bj.prototype.getValue=function(){return Zd(Nd(this,2),"")};
...
u(fj,I);fj.prototype.getMessage=function(){return Zd(Nd(this,1),"")};function gj(a){I.call(this,a)}
...
u(Bj,I);Bj.prototype.getPlayerType=function(){var a=Nd(this,7);return null==a?0:a};
Bj.prototype.setVideoId=function(a){return D(this,19,a)};
function Dj(a,b){Xd(a,68,Ej,b)}
function Ej(a){I.call(this,a)}
u(Ej,I);Ej.prototype.getId=function(){return Zd(Nd(this,2),"")};
var Cj=[83,68];function Fj(a){I.call(this,a)}
u(Fj,I);function Gj(a){I.call(this,a)}
u(Gj,I);function Hj(a){I.call(this,a)}
u(Hj,I);function Ij(a){I.call(this,a,449)}
u(Ij,I);
...
353,354,355,356,357,358,361,363,364,368,369,370,373,374,375,378,380,381,388,389,403,410,412,429,413,414,415,416,417,418,430,423,424,425,426,427,431,117,439,441,448];var Kj={rj:0,cj:1,ij:2,jj:4,oj:8,kj:16,lj:32,qj:64,pj:128,ej:256,gj:512,nj:1024,fj:2048,hj:4096,dj:8192,mj:16384};function Lj(a){I.call(this,a)}
u(Lj,I);function gk(a){I.call(this,a)}
u(gk,I);gk.prototype.setVideoId=function(a){return Pd(this,1,hk,a)};
gk.prototype.getPlaylistId=function(){return Yd(this,2===Qd(this,hk)?2:-1)};
...
;var qk=z.window,rk,sk,tk=(null==qk?void 0:null==(rk=qk.yt)?void 0:rk.config_)||(null==qk?void 0:null==(sk=qk.ytcfg)?void 0:sk.data_)||{};A("yt.config_",tk);function uk(){pk(tk,arguments)}
...
null==(r=wh.screen)?void 0:r.availWidth;var w;e.u_cd=null==(w=wh.screen)?void 0:w.colorDepth}catch(fa){}h=b.i;try{var t=h.screenX;var y=h.screenY}catch(fa){}try{var E=h.outerWidth;var F=h.outerHeight}catch(fa){}try{var O=h.innerWidth;var N=h.innerHeight}catch(fa){}try{var Q=h.screenLeft;var da=h.screenTop}catch(fa){}try{O=h.innerWidth,N=h.innerHeight}catch(fa){}try{var U=h.screen.availWidth;var mb=h.screen.availTop}catch(fa){}t=[Q,da,t,y,U,mb,E,F,O,N];try{var Wa=(b.i.top||window).document,ma="CSS1Compat"==
Wa.compatMode?Wa.documentElement:Wa.body;var H=(new bf(ma.clientWidth,ma.clientHeight)).round()}catch(fa){H=new bf(-12245933,-12245933)}Wa=H;H={};var la=void 0===la?z:la;ma=new Rh;la.SVGElement&&la.document.createElementNS&&ma.set(0);y=Eh();y["allow-top-navigation-by-user-activation"]&&ma.set(1);y["allow-popups-to-escape-sandbox"]&&ma.set(2);la.crypto&&la.crypto.subtle&&ma.set(3);la.TextDecoder&&la.TextEncoder&&ma.set(4);la=Sh(ma);H.bc=la;H.bih=Wa.height;H.biw=Wa.width;H.brdim=t.join();b=b.j;b=(H.vis=
...
A("yt.ads_.signals_.getAdSignalsString",function(a){return Nk(Sk(a))});Date.now();var Uk="XMLHttpRequest"in z?function(){return new XMLHttpRequest}:null;
...
function Gl(a,b,c){a=a.fc;if("WEB"===a||"MWEB"===a||1===a||2===a)if(b){c=Rd(b,Hi,96)||new Hi;var d=ml();d=Object.keys(Zi).indexOf(d);d=-1===d?null:d;null!==d&&D(c,3,d);G(b,Hi,96,c)}else c&&(c.client.mainAppWebInfo=null!=(d=c.client.mainAppWebInfo)?d:{},c.client.mainAppWebInfo.webDisplayMode=ml())}
function Hl(a,b){var c;if(M("web_log_memory_total_kbytes")&&(null==(c=z.navigator)?0:c.deviceMemory)){var d;c=null==(d=z.navigator)?void 0:d.deviceMemory;a?D(a,95,1E6*c):b&&(b.client.memoryTotalKbytes=""+1E6*c)}}
function Il(a,b,c){if(a.appInstallData)if(b){var d;c=null!=(d=Rd(b,Gi,62))?d:new Gi;D(c,6,a.appInstallData);G(b,Gi,62,c)}else c&&(c.client.configInfo=c.client.configInfo||{},c.client.configInfo.appInstallData=a.appInstallData)}
...
;function Ml(a){a=Object.assign({},a);delete a.Authorization;var b=ng();if(b){var c=new Wh;c.update(L("INNERTUBE_API_KEY"));c.update(b);a.hash=ed(c.digest(),3)}return a}
...
$l.prototype.pause=function(){var a=B("yt.scheduler.instance.pause");a&&a()};var Qh=am();var bm=$c||ad;function cm(a){var b=Tb();return b?0<=b.toLowerCase().indexOf(a):!1}
...
function vn(){var a,b,c,d;return x(function(e){switch(e.i){case 1:a=em();if(null==(b=a)?0:b.hasSucceededOnce)return e.return(!0);var f;if(f=bm)f=/WebKit\/([0-9]+)/.exec(Tb()),f=!!(f&&600<=parseInt(f[1],10));f&&(f=/WebKit\/([0-9]+)/.exec(Tb()),f=!(f&&602<=parseInt(f[1],10)));if(f||Mc)return e.return(!1);try{if(c=self,!(c.indexedDB&&c.IDBIndex&&c.IDBKeyRange&&c.IDBObjectStore))return e.return(!1)}catch(g){return e.return(!1)}if(!("IDBTransaction"in self&&"objectStoreNames"in IDBTransaction.prototype))return e.return(!1);
...
;function Go(){Ve.call(this);var a=this;this.l=!1;this.j=Ph();this.j.ia("networkstatus-online",function(){if(a.l&&M("offline_error_handling")){var b=Eo().get("errors",!0);if(b){for(var c in b)if(b[c]){var d=new R(c,"sent via offline_errors");d.name=b[c].name;d.stack=b[c].stack;d.level=b[c].level;Dk(d)}Eo().set("errors",{},2592E3,!0)}}})}
u(Go,Ve);function Ho(){if(!Go.i){var a=B("yt.networkStatusManager.instance")||new Go;A("yt.networkStatusManager.instance",a);Go.i=a}return Go.i}
...
return a};
Go.prototype.sendNetworkCheckRequest=Go.prototype.mb;Go.prototype.listen=Go.prototype.ia;Go.prototype.enableErrorFlushing=Go.prototype.Pc;Go.prototype.getWindowStatus=Go.prototype.Uc;Go.prototype.networkStatusHint=Go.prototype.ya;Go.prototype.isNetworkAvailable=Go.prototype.W;Go.getInstance=Ho;function Io(a){a=void 0===a?{}:a;Ve.call(this);var b=this;this.j=this.s=0;this.l=Ho();var c=B("yt.networkStatusManager.instance.listen").bind(this.l);c&&(a.lb?(this.lb=a.lb,c("networkstatus-online",function(){Jo(b,"publicytnetworkstatus-online")}),c("networkstatus-offline",function(){Jo(b,"publicytnetworkstatus-offline")})):(c("networkstatus-online",function(){We(b,"publicytnetworkstatus-online")}),c("networkstatus-offline",function(){We(b,"publicytnetworkstatus-offline")})))}
u(Io,Ve);Io.prototype.W=function(){var a=B("yt.networkStatusManager.instance.isNetworkAvailable");return a?a.bind(this.l)():!0};
...
function Jo(a,b){a.lb?a.j?(Qh.ga(a.s),a.s=Qh.V(function(){a.o!==b&&(We(a,b),a.o=b,a.j=P())},a.lb-(P()-a.j))):(We(a,b),a.o=b,a.j=P()):We(a,b)}
...
function Ul(a,b,c,d){function e(y){y=void 0===y?!1:y;var E;if(d.retry&&"www.youtube-nocookie.com"!=h&&(y||M("skip_ls_gel_retry")||"application/json"!==g.headers["Content-Type"]||(E=Rl(b,c,m,k)),E)){var F=g.onSuccess,O=g.onFetchSuccess;g.onSuccess=function(N,Q){Sl(E);F(N,Q)};
c.onFetchSuccess=function(N,Q){Sl(E);O(N,Q)}}try{y&&d.retry&&!d.lc.bypassNetworkless?(g.method="POST",d.lc.writeThenSend?Oo().writeThenSend(t,g):Oo().sendAndWrite(t,g)):M("web_all_payloads_via_jspb")?dl(t,g):(g.method="POST",g.postParams||(g.postParams={}),dl(t,g))}catch(N){if("InvalidAccessError"==N.name)E&&(Sl(E),E=0),Ek(Error("An extension is blocking network request."));
...
Ip.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var qb=z.ytEventsEventsListeners||{};A("ytEventsEventsListeners",qb);var Kp=z.ytEventsEventsCounter||{count:0};A("ytEventsEventsCounter",Kp);
...
function Np(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=Lp(a,b,c,d);if(e)return e;e=++Kp.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(h){h=new Ip(h);if(!ef(h.relatedTarget,function(k){return k==a}))return h.currentTarget=a,h.type=b,c.call(a,h)}:function(h){h=new Ip(h);
...
Za(Qp,J);Qp.prototype.P=function(a){void 0===a.i&&Jp(a);var b=a.i;void 0===a.j&&Jp(a);this.j=new af(b,a.j)};
...
;var Wp=z.ytPubsubPubsubInstance||new K,Xp=z.ytPubsubPubsubSubscribedKeys||{},Yp=z.ytPubsubPubsubTopicToKeys||{},Zp=z.ytPubsubPubsubIsSynchronous||{};function $p(a,b){var c=aq();if(c&&b){var d=c.subscribe(a,function(){var e=arguments;var f=function(){Xp[d]&&b.apply&&"function"==typeof b.apply&&b.apply(window,e)};
...
function aq(){return z.ytPubsubPubsubInstance}
...
var nq=new mq,oq=new mq,pq,qq=!0,rq=z.ytLoggingTransportGELQueue_||new Map;A("ytLoggingTransportGELQueue_",rq);var sq=z.ytLoggingTransportGELProtoQueue_||new Map;A("ytLoggingTransportGELProtoQueue_",sq);var tq=z.ytLoggingTransportTokensToCttTargetIds_||{};A("ytLoggingTransportTokensToCttTargetIds_",tq);var uq=z.ytLoggingTransportTokensToJspbCttTargetIds_||{};A("ytLoggingTransportTokensToJspbCttTargetIds_",uq);var vq={};function wq(){var a=B("yt.logging.ims");a||(a=new fq,A("yt.logging.ims",a));return a}
...
function Iq(a,b,c,d,e){d=void 0===d?{}:d;var f=Math.round(P()),g=a.size,h=new Map([].concat(ia(a)));h=p(h);for(var k=h.next();!k.done;k=h.next()){var m=p(k.value).next().value,q=a.get(m);k=new ik;var r=Kl(b.config_||El());G(k,Ri,1,r);q=q?Nq(q):[];q=p(q);for(r=q.next();!r.done;r=q.next())Xd(k,3,Ij,r.value);(q=uq[m])&&Oq(k,m,q);delete uq[m];m="visitorOnlyApprovedKey"===m;Pq(k,f,m);Lq(d);k=be(k);m=Mq(d,m,function(){g--;g||c()},function(){g--;
g||c()},e);
...
function Oq(a,b,c){if(Yd(c,1===Qd(c,hk)?1:-1))var d=1;else if(c.getPlaylistId())d=2;else return;G(a,gk,4,c);a=Rd(a,Ri,1)||new Ri;c=Rd(a,Pi,3)||new Pi;var e=new Oi;e.setToken(b);D(e,1,d);Xd(c,12,Oi,e);G(a,Pi,3,c)}
...
;var Sq=z.ytLoggingGelSequenceIdObj_||{};A("ytLoggingGelSequenceIdObj_",Sq);
...
;var Wq=z.ytLoggingGelSequenceIdObj_||{};A("ytLoggingGelSequenceIdObj_",Wq);function Xq(a,b,c){c=void 0===c?{}:c;var d=Math.round(c.timestamp||P());D(a,1,d<Number.MAX_SAFE_INTEGER?d:0);var e=Vp();d=new Hj;D(d,1,c.timestamp||!isFinite(e)?-1:e);if(M("log_sequence_info_on_gel_web")&&c.ba){e=c.ba;var f=Uq(e),g=new Gj;D(g,2,f);D(g,1,e);G(d,Gj,3,g);c.ac&&delete Wq[c.ba]}G(a,Hj,33,d);(c.uc?Hq:Bq)({endpoint:"log_event",payload:a,cttAuthInfo:c.cttAuthInfo,Ka:c.Ka},b)}
;function Yq(a,b){b=void 0===b?{}:b;var c=!1;L("ytLoggingEventsDefaultDisabled",!1)&&(c=!0);Xq(a,c?null:Ep,b)}
;function Zq(a,b){var c=new Ij;Vd(c,xj,72,Jj,a);Yq(c,b)}
function $q(a,b,c){var d=new Ij;Vd(d,wj,73,Jj,a);c?Xq(d,c,b):Yq(d,b)}
function ar(a,b,c){var d=new Ij;Vd(d,vj,78,Jj,a);c?Xq(d,c,b):Yq(d,b)}
function br(a,b,c){var d=new Ij;Vd(d,yj,208,Jj,a);c?Xq(d,c,b):Yq(d,b)}
function cr(a,b,c){var d=new Ij;Vd(d,oj,156,Jj,a);c?Xq(d,c,b):Yq(d,b)}
function dr(a,b,c){var d=new Ij;Vd(d,sj,215,Jj,a);c?Xq(d,c,b):Yq(d,b)}
function er(a,b,c){var d=new Ij;Vd(d,nj,111,Jj,a);c?Xq(d,c,b):Yq(d,b)}
...
Eb.length||isNaN(Number(Eb[0]))?2!==Eb.length||isNaN(Number(Eb[0]))||isNaN(Number(Eb[1]))||(D(rd,2,Number(Eb[0])),D(rd,3,Number(Eb[1]))):D(rd,2,Number(Eb[0])));var xc=new fj;D(xc,1,H.message);D(xc,3,H.name);D(xc,6,H.sampleWeight);"ERROR"===we?D(xc,2,2):"WARNING"===we?D(xc,2,1):D(xc,2,0);var Sj=new dj;D(Sj,1,!0);Vd(Sj,cj,3,ej,rd);var $b=new $i;D($b,3,window.location.href);for(var gp=L("FEXP_EXPERIMENTS",[]),Tj=0;Tj<gp.length;Tj++){var vv=gp[Tj];Ed($b);Od($b,5,2,!1).push(vv)}var Uj=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");
if(!vk()&&Uj)for(var hp=p(Object.keys(Uj)),yc=hp.next();!yc.done;yc=hp.next()){var ip=yc.value,Vj=new bj;D(Vj,1,ip);Vj.setValue(String(Uj[ip]));Xd($b,4,bj,Vj)}var Wj=H.params;if(Wj){var jp=p(Object.keys(Wj));for(yc=jp.next();!yc.done;yc=jp.next()){var kp=yc.value,Xj=new bj;D(Xj,1,"client."+kp);Xj.setValue(String(Wj[kp]));Xd($b,4,bj,Xj)}}var lp=L("SERVER_NAME"),mp=L("SERVER_VERSION");if(lp&&mp){var Yj=new bj;D(Yj,1,"server.name");Yj.setValue(lp);Xd($b,4,bj,Yj);var Zj=new bj;D(Zj,1,"server.version");
Zj.setValue(mp);Xd($b,4,bj,Zj)}var Jg=new gj;G(Jg,$i,1,$b);G(Jg,dj,2,Sj);G(Jg,fj,3,xc);fp=Jg}var np=fp;if(!np)break a;var op=new Ij;Vd(op,gj,163,Jj,np);Yq(op)}else{if(zr())var pp=void 0;else{var xe={stackTrace:H.stack};H.fileName&&(xe.filename=H.fileName);var Fb=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Fb.length&&(1!==Fb.length||isNaN(Number(Fb[0]))?2!==Fb.length||isNaN(Number(Fb[0]))||isNaN(Number(Fb[1]))||(xe.lineNumber=Number(Fb[0]),xe.columnNumber=Number(Fb[1])):xe.lineNumber=
...
(Vq(!0),!M("web_fp_via_jspb_and_json")))break c;Vq()}else{if(M("web_fp_via_jspb")&&(Vq(!0),!M("web_fp_via_jspb_and_json")))break b;Vq()}}if(!M("suppress_error_204_logging")){var ye=H.params||{},ac={urlParams:{a:"logerror",t:"jserror",type:H.name,msg:H.message.substr(0,250),line:H.lineNumber,level:h,"client.name":ye.name},postParams:{url:L("PAGE_NAME",window.location.href),file:H.fileName},method:"POST"};ye.version&&(ac["client.version"]=ye.version);if(ac.postParams){H.stack&&(ac.postParams.stack=
H.stack);for(var xp=p(Object.keys(ye)),dk=xp.next();!dk.done;dk=xp.next()){var yp=dk.value;ac.postParams["client."+yp]=ye[yp]}var ek=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(ek)for(var zp=p(Object.keys(ek)),fk=zp.next();!fk.done;fk=zp.next()){var Ap=fk.value;ac.postParams[Ap]=ek[Ap]}var Bp=L("SERVER_NAME"),Cp=L("SERVER_VERSION");Bp&&Cp&&(ac.postParams["server.name"]=Bp,ac.postParams["server.version"]=Cp)}dl(L("ECATCHER_REPORT_HOST","")+"/error_204",ac)}try{rr.add(H.message)}catch($w){}sr++}}}}
...
return a.join("")}
;var Gr=z.ytLoggingDocDocumentNonce_;Gr||(Gr=Fr(),A("ytLoggingDocDocumentNonce_",Gr));var Hr=Gr;var Ir={ai:0,ue:1,Fe:2,Xl:3,ci:4,uq:5,Nm:6,Ao:7,Sn:8,oo:9,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS",9:"RICH_GRID_WATCH"};function Jr(a){this.G=a}
...
;function fs(){return lg()||bm&&cm("applewebkit")&&!cm("version")&&(!cm("safari")||cm("gsa/"))||Pc&&cm("version/")?!0:L("EOM_VISITOR_DATA")?!1:!0}
...
Mt[Mt.PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT]="PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT";Mt[Mt.PLAYER_ROTATION_TYPE_UNKNOWN]="PLAYER_ROTATION_TYPE_UNKNOWN";var Nt="actionVisualElement spinnerInfo resourceInfo playerInfo commentInfo mdxInfo watchInfo thumbnailLoadInfo creatorInfo unpluggedInfo reelInfo subscriptionsFeedInfo requestIds mediaBrowserActionInfo musicLoadActionInfo shoppingInfo webViewInfo prefetchInfo accelerationSession commerceInfo webInfo tvInfo kabukiInfo mwebInfo musicInfo".split(" ");var Ot=z.ytLoggingLatencyUsageStats_||{};A("ytLoggingLatencyUsageStats_",Ot);function Pt(){this.i=0}
function Qt(){Pt.i||(Pt.i=new Pt);return Pt.i}
Pt.prototype.tick=function(a,b,c,d){Rt(this,"tick_"+a+"_"+b)||(c={timestamp:c,cttAuthInfo:d},M("web_csi_via_jspb")?(d=new Fj,D(d,1,a),D(d,2,b),a=new Ij,Vd(a,Fj,5,Jj,d),Yq(a,c)):lm("latencyActionTicked",{tickName:a,clientActionNonce:b},c))};
...
Pt.prototype.jspbInfo=function(a,b,c){for(var d="",e=0;e<a.toJSON().length;e++)void 0!==a.toJSON()[e]&&(d=0===e?d.concat(""+e):d.concat("_"+e));Rt(this,"info_"+d+"_"+b)||(D(a,2,b),b={cttAuthInfo:c},c=new Ij,Vd(c,Bj,7,Jj,a),Yq(c,b))};
...
function Tt(a,b){if(M("skip_setting_info_in_csi_data_object")){var c=Zd(Nd(a,3),"");c&&(lt(b).loadType=c)}else pt(b).push(be(a));vt(b||"").jspbInfo.push(a);c=qt(b);b=jt(b).cttAuthInfo;Qt().jspbInfo(a,c,b)}
...
D(a,1,e),e=new Ij,Vd(e,zj,6,Jj,a),Yq(e,b)):lm("latencyActionBaselined",{clientActionNonce:e},b))):Qt().tick(a,e,b,f);rt(c);return d}
...
function ju(a,b,c){var d,e,f,g,h,k,m,q,r,w,t,y,E,F,O,N,Q,da,U,mb,Wa,ma,H,la,fa,ue,ve,pd;return x(function(oa){switch(oa.i){case 1:oa.B(2);break;case 3:if((d=oa.j)&&!d.isExpired())return oa.return(Promise.resolve(d.i()));case 2:if(null==(e=b)?0:null==(f=e.ha)?0:f.context)for(g=p([]),h=g.next();!h.done;h=g.next())k=h.value,k.wr(b.ha.context);if(null==(m=a.j)||!m.Br(b.input,b.ha)){oa.B(4);break}return v(oa,a.j.qr(b.input,b.ha),5);case 5:return q=oa.j,M("kevlar_process_local_innertube_responses_killswitch")||
ku(a,q,b),oa.return(q);case 4:return(t=null==(w=b.config)?void 0:w.Fa)&&a.i.has(t)&&M("web_memoize_inflight_requests")?r=a.i.get(t):(y=JSON.stringify(b.ha),O=null!=(F=null==(E=b.za)?void 0:E.headers)?F:{},b.za=Object.assign({},b.za,{headers:Object.assign({},O,c)}),N=Object.assign({},b.za),"POST"===b.za.method&&(N=Object.assign({},N,{body:y})),(null==(Q=b.config)?0:Q.jd)&&Z(b.config.jd),da=function(){return a.M.fetch(b.input,N,b.config)},r=da(),t&&a.i.set(t,r)),v(oa,r,6);
...
ba:b};d=p(d);for(var g=d.next();!g.done;g=d.next())g=g.value.getAsJson(),(rb(g)||!g.trackingParams&&!g.veType)&&yr(Error("Child VE logged with no data"));if(M("il_via_jspb")){var h=new sj;h.j(b);uj(h,c.getAsJspb());hb(e,function(k){k=k.getAsJspb();Xd(h,3,mj,k)});
...
function Du(){for(var a=Math.random()+"",b=[],c=0,d=0;d<a.length;d++){var e=a.charCodeAt(d);255<e&&(b[c++]=e&255,e>>=8);b[c++]=e}return ed(b,3)}
...
;var Su=z.caches,Tu;function Uu(a){var b=a.indexOf(":");return-1===b?{nc:a}:{nc:a.substring(0,b),datasyncId:a.substring(b+1)}}
...
function nv(a,b,c,d){d=void 0===d?null:d;var e=df("SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function xv(a,b,c,d,e,f){var g=void 0===g?"trayride":g;c?(a.state=2,jv(c,function(){window[g]?yv(a,d,g,e):(a.state=3,ov(c),yr(new R("Unable to load Botguard","from "+c)))},f)):b?(f=df("SCRIPT"),f.textContent=b,f.nonce=ic(),document.head.appendChild(f),document.head.removeChild(f),window[g]?yv(a,d,g,e):(a.state=4,yr(new R("Unable to load Botguard from JS")))):yr(new R("Unable to load VM; no url or JS provided"))}
...
l.Kb=function(a){je(this.i);this.i=a};function zv(){uv.apply(this,arguments)}
u(zv,uv);zv.prototype.Nb=function(){this.state=8};
zv.prototype.zb=function(){return B("yt.abuse.playerAttLoader")};
zv.prototype.Kb=function(a){je(B("yt.abuse.playerAttLoader"));A("yt.abuse.playerAttLoader",a);a&&A("yt.abuse.playerAttLoaderRun",function(b){return a.snapshot(b)})};var Av=new zv;var Bv=new uv;function Cv(){return M("use_player_abuse_bg_library")?Av.isInitialized():Bv.isInitialized()}
...
var Nv;u(Mv,Lv);Mv.prototype.m=function(){if(M("web_fp_via_jspb")){var a=new lj,b=Qr();b&&D(a,1,b);b=new Ij;Vd(b,lj,380,Jj,a);Yq(b);M("web_fp_via_jspb_and_json")&&lm("finalPayload",{csn:Qr()})}else lm("finalPayload",{csn:Qr()})};
...
fw.prototype.D=function(){cw.prototype.D.call(this);delete this.api};function gw(a){a=void 0===a?!1:a;J.call(this);this.j=new K(a);le(this,this.j)}
...
hw.prototype.D=function(){this.destination=this.l=null;gw.prototype.D.call(this)};function iw(a,b,c){J.call(this);this.destination=a;this.origin=c;this.j=Np(window,"message",this.l.bind(this));this.connection=new hw(this,a,b);le(this,this.connection)}
...
function nw(a){var b=df("A");Db("This URL is never added to the DOM");fc(b,new Ob(a,Pb));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+kc(a)}
...
u(qw,pw);function rw(a,b,c,d){J.call(this);var e=this;this.u=b;this.webPlayerContextConfig=d;this.da=!1;this.api={};this.X=this.s=null;this.L=new K;this.j={};this.R=this.Y=this.elementId=this.va=this.config=null;this.P=!1;this.m=this.H=null;this.la={};this.Wa=["onReady"];this.lastError=null;this.Ja=NaN;this.K={};this.Xa=new qw(this);this.T=0;this.l=this.o=a;le(this,this.L);sw(this);tw(this);le(this,this.Xa);c?this.T=Xk(function(){e.loadNewVideoConfig(c)},0):d&&(uw(this),vw(this))}
...
function Aw(a){var b=cf(a.elementId);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.elementId));return b}
...
function yw(a,b){var c=b;if("string"===typeof b){if(a.la[b])return a.la[b];c=function(){var d=Ja.apply(0,arguments),e=B(b);if(e)try{e.apply(z,d)}catch(f){xr(f)}};
a.la[b]=c}return c?c:null}
function Jw(a,b){var c="ytPlayer"+b+a.u;a.j[b]=c;z[c]=function(d){var e=Xk(function(){if(!a.i()){try{a.L.ta(b,null!=d?d:void 0)}catch(h){yr(new R("PlayerProxy error when creating global callback",{error:h,event:b,playerId:a.u,data:d}))}var f=a.K,g=String(e);g in f&&delete f[g]}},0);
sb(a.K,String(e))};
return c}
...
l.D=function(){Dw(this);if(this.m&&this.config&&this.m.destroy)try{this.m.destroy()}catch(b){xr(b)}this.la=null;for(var a in this.j)this.j.hasOwnProperty(a)&&(z[this.j[a]]=null);this.va=this.config=this.api=null;delete this.o;delete this.l;J.prototype.D.call(this)};
...
;var Kw={},Lw="player_uid_"+(1E9*Math.random()>>>0);function Mw(a,b){var c="player",d=!1;d=void 0===d?!0:d;c="string"===typeof c?cf(c):c;var e=Lw+"_"+Ra(c),f=Kw[e];if(f&&d)return Nw(a,b)?f.api.loadVideoByPlayerVars(a.args||null):f.loadNewVideoConfig(a),f.api;f=new rw(c,e,a,b);Kw[e]=f;cq("player-added",f.api);me(f,function(){delete Kw[f.getId()]});
return f.api}
...
function Uw(){Ow&&Ow.sendAbandonmentPing&&Ow.sendAbandonmentPing();L("PL_ATT")&&(M("use_player_abuse_bg_library")?Av.dispose():Bv.dispose());for(var a=Qh,b=0,c=qv.length;b<c;b++)a.ga(qv[b]);qv.length=0;ov("//static.doubleclick.net/instream/ad_status.js");rv=!1;uk("DCLKSTAT",0);ke(Qw,Pw);Ow&&(Ow.removeEventListener("onVideoDataChange",Rw),Ow.destroy())}
